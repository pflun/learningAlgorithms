...
# after reverse： O -> L -> L -> E -> H -> ' ' -> D -> L - > R -> O -> W ->NULL
# break at " ", reverse single word, connect tail of last word to the newly reversed head, finally reverse the last word
...
class Solution(object):
    ...
    # reverse word and return new head and new tail
